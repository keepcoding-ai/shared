...
2. O app ainda **não é assinado pela Apple**. Na primeira vez, o Mac bloqueia:
   clique com o botão direito em **Eitri** → **Abrir** → **Abrir**.
   Se aparecer "está danificado", rode no Terminal:
   ```
